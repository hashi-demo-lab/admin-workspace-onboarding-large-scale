...
locals {
  workspaceConfig = flatten([for workspace in fileset(path.module, var.workspace-yaml-filepath) : yamldecode(file(workspace))])
...
module "workspace" {
  source = "github.com/hashi-demo-lab/terraform-tfe-onboarding-module?ref=v0.4.0"
